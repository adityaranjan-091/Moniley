...
export default function LoginPage() {
  ...
  return (
    <div className="flex flex-col items-center text-center">
      ...
      <p className="text-sm text-muted-foreground mb-7">Sign in to your Moniley account</p>
      ...
      <div className="mb-5 flex w-full items-center gap-3">
        ...
        <span className="text-xs text-primary font-medium">Or sign in with email</span>
        <div className="h-px flex-1 bg-border" />
      </div>

      {/* Error */}
      {error && (
        <div className="mb-4 w-full rounded-xl bg-destructive/10 px-4 py-3 text-sm text-destructive text-left">
          {error}
        </div>
      )}
