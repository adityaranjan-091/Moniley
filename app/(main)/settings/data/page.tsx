        ...
        <div className="space-y-6">
            ...
            <div className="space-y-4">
                ...
                <div className="flex flex-col gap-4 sm:flex-row">
                    ...
                    <Button variant="outline" className="flex items-center gap-2" onClick={() => router.push("/reports")}>
                ...
                <div className="rounded-lg border border-destructive/20 bg-destructive/5 p-4 space-y-4">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-xs text-muted-foreground">Delete all transactions, budgets, and goals. Account remains.</p>
                        </div>
                        <AlertDialog>
                            ...
                            <AlertDialogContent>
                                <AlertDialogHeader>
                                    ...
                                    <AlertDialogDescription>
                                        This action cannot be undone. This will permanently delete your financial data.
                                    </AlertDialogDescription>
                                </AlertDialogHeader>
                                <AlertDialogFooter>
                                    <AlertDialogCancel>Cancel</AlertDialogCancel>
                                    <AlertDialogAction onClick={handleResetData} className="bg-destructive hover:bg-destructive/90">Continue</AlertDialogAction>
                                </AlertDialogFooter>
                            </AlertDialogContent>
                        </AlertDialog>
                    </div>
