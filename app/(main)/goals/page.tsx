...
export default function GoalsPage() {
        ...
        async function fetchBalance() {
            ...
            try {
                const res = await fetch(
                    `/api/transactions?userId=${encodeURIComponent(session.user.email)}`
                );
    ...
    return (
        <div className="mx-auto max-w-6xl space-y-8">
            ...
            {/* Savings Summary */}
            <div className="rounded-xl bg-gradient-to-br from-primary/90 to-primary p-6 text-primary-foreground shadow-lg">
