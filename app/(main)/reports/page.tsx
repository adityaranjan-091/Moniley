...
export default function ReportsPage() {
    ...
    }, [session, reportType, selectedMonth, selectedYear]);
    ...
    const handleExportPDF = () => {
        ...
        doc.text(`Total Expenses: ${data.summary.expense.toLocaleString()}`, 14, 38);
        ...
        doc.save(`report-${reportType}-${selectedYear}-${reportType === 'monthly' ? parseInt(selectedMonth) + 1 : ''}.pdf`);
    };
        ...
        <div className="space-y-8 p-4 md:p-8" ref={reportRef}>
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                <div>
                    ...
                    <p className="text-muted-foreground">Visualize your financial health.</p>
                </div>
                ...
                <>
                    ...
                    <div className="grid gap-4 md:grid-cols-3">
                        ...
                        <SummaryCard
                            ...
                            color="text-rose-500"
                            inverseTrend // higher expense is 'bad' if we wanted to color code trends, but for now just showing diff
                        />
                        <SummaryCard
                            title="Net Savings"
                    ...
                    <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-7">
                        ...
                        <Card className="col-span-4">
                            <CardHeader>
                                <CardTitle>{reportType === 'monthly' ? 'Daily Spending Trend' : 'Monthly Financial Trend'}</CardTitle>
                            </CardHeader>
...
function SummaryCard({ title, value, prevValue, icon, color, inverseTrend }: any) {
