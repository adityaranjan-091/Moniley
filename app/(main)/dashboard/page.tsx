...
export default function DashboardPage() {
    ...
    async function fetchData() {
        try {
            ...
            const res = await fetch(`/api/dashboard?userId=${encodeURIComponent(email)}&search=${encodeURIComponent(search)}`);
...
function StatsCard({ title, value, icon, textColor }: { title: string, value: number, icon: React.ReactNode, textColor?: string }) {
    return (
        <Card>
